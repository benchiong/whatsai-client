...
class SDI2ICard(Card):
    ...
    def __init__(self, cache_out=True, valid_inputs=False):
        ...
        self.latent_from_image = Comp_Image2Latent(display_name="Load Image For Image to Image")
        self.register_comp(self.latent_from_image)
    ...
    def run(self,
        ...
        with torch.inference_mode():
            ...
            image_path = base_inputs.get("image_path")
            latent_image = self.latent_from_image(
