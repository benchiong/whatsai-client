(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("electron-serve"), require("electron-store"), require("tree-kill"));
	else if(typeof define === 'function' && define.amd)
		define(["electron-serve", "electron-store", "tree-kill"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("electron-serve"), require("electron-store"), require("tree-kill")) : factory(root["electron-serve"], root["electron-store"], root["tree-kill"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE_electron_serve__, __WEBPACK_EXTERNAL_MODULE_electron_store__, __WEBPACK_EXTERNAL_MODULE_tree_kill__) => {
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_tree_kill__;
...
/* harmony import */ var tree_kill__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tree-kill */ "tree-kill");
/* harmony import */ var tree_kill__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(tree_kill__WEBPACK_IMPORTED_MODULE_6__);
...
(async () => {
  ...
  const pythonExePath = path__WEBPACK_IMPORTED_MODULE_0___default().join(__dirname, "main.exe");
  console.log(__dirname);
  fs__WEBPACK_IMPORTED_MODULE_5___default().access(pythonExePath, (fs__WEBPACK_IMPORTED_MODULE_5___default().constants).F_OK, err => {
    if (err) {
      console.error('Python exe file not exits.');
    } else {
      pythonBackend = (0,child_process__WEBPACK_IMPORTED_MODULE_4__.execFile)(pythonExePath, [], (error, stdout, stderr) => {
        if (error) {
...
function cleanUp() {
  ...
  if (pythonBackend && pythonBackend.pid) {
    tree_kill__WEBPACK_IMPORTED_MODULE_6___default()(pythonBackend.pid, 'SIGTERM', err => {
      if (err) {
        console.error(err);
      }
    });
...
electron__WEBPACK_IMPORTED_MODULE_1__.app.on('quit', () => {
