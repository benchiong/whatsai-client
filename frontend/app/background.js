...
let managerUrl = isProd ? null : "http://127.0.0.1:8820/";
  ...
  async startProcess() {
    ...
    fs__WEBPACK_IMPORTED_MODULE_4___default().access(this.executablePath, (fs__WEBPACK_IMPORTED_MODULE_4___default().constants).F_OK, err => {
      ...
      this.findAvailablePort(8820).then(port => {
        ...
        this.process = (0,child_process__WEBPACK_IMPORTED_MODULE_2__.spawn)(this.executablePath, ["--port", this.port.toString()], {
          stdio: "inherit"
        });
        this.monitor = true;
        if (this.port) {
...
(async () => {
  ...
  const pythonExePath = path__WEBPACK_IMPORTED_MODULE_0___default().join(__dirname, "backend-manager");
