...
electron__WEBPACK_IMPORTED_MODULE_1__.app.on("window-all-closed", () => {
  if (process.platform !== "darwin") electron__WEBPACK_IMPORTED_MODULE_1__.app.quit();
});
